...
void SettingsActivity::onEnter() {
  ...
  systemSettings.push_back(SettingInfo::Action("Kobo Sync", SettingAction::KoboSync));
  ...
  if (setting.type == SettingType::TOGGLE && setting.valuePtr != nullptr) {
    ...
    switch (setting.action) {
      ...
      case SettingAction::OPDSBrowser:
        ...
        break;
      case SettingAction::KoboSync: {
        Activity* a = KoboIntegration::createSettingsActivity(renderer, mappedInput, onComplete);
        if (a) enterSubActivity(a);
        break;
      }
